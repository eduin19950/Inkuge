...
export default function LeadershipGalleryPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const leadershipGalleries = allGalleries.filter((g: PhotoGallery) => 
          g.ministry_name && g.ministry_name.toLowerCase().includes('leadership')
        )
        setGalleries(leadershipGalleries)
      } catch (error) {
      ...
      <section className="bg-gradient-to-br from-green-600 to-green-800 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Leadership Training Gallery</h1>
            <p className="text-xl text-green-100">
              Capturing moments from our leadership conferences, workshops, and training events
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">No leadership training galleries available yet. Check back soon!</p>
            </div>
          ) : (
