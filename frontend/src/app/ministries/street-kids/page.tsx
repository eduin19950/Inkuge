...
import { Heart, Users, Utensils, GraduationCap, ArrowRight, ChevronDown, ChevronUp, Video, Camera, CalendarDays, DollarSign } from 'lucide-react'
    ...
    <div>
      ...
      <section className="py-16 md:py-20 bg-white border-t border-gray-100">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-gray-600 mb-12 text-center max-w-2xl mx-auto">
            Discover more about our street kids ministry through videos, photos, testimonies, and more
          </p>

          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-6xl mx-auto">
            <Link 
              href="/ministries/street-kids/videos"
            ...
            <Link 
              href="/ministries/street-kids/gallery"
              className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all text-center group border border-gray-200"
            >
            ...
            <Link 
              href="/ministries/street-kids/testimonies"
              className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all text-center group border border-gray-200"
            >
            ...
            <Link 
              href="/ministries/street-kids/activities"
              className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all text-center group border border-gray-200"
            >
            ...
            <Link 
              href="/ministries/street-kids/donate"
              className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all text-center group border border-gray-200"
            >
